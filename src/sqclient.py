...
class SonarqubeClient:
    ...
    def get_pull_request_status(self, pull_request):
        ...
        '''
        projectstatus = self.client.qualitygates.get_project_qualitygates_status(
    ...
    def get_pull_request_issues(self, pull_request):
        '''
            ...
            pull_request is the pull request number
        '''
        issues = list(self.client.issues.search_issues(
            componentKeys=self.projectKey,
            pullRequest=pull_request
            ))
        return issues
    ...
    def get_sonarqube_pull_request_url(self, url, pull_request):
        '''
            ...
            pull_request is the pull request number
        '''
        url = "{}/dashboard?id={}&pullRequest={}".format(
            url,
            self.projectKey,
            pull_request
            )
